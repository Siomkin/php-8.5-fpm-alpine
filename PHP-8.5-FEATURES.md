...
This Docker image comes with PHP 8.5.3 and all the necessary extensions to take advantage of these new features. You can start using them immediately in your applications.
